...
<body>
  ...
  <?php if( isset( $_POST['op1'] ) && isset( $_POST['op3'] ) ){
    ...
    echo "<h2>" . $_POST['szamlalo'] . ". Eredmény</h2>";
  ...
  <form action="<?php print $_SERVER['PHP_SELF'] ?>" method="post">
    <input type="hidden" name="szamlalo" id="szamlalo" value="<?php echo ( intval( $_POST['szamlalo'] ) + 1 ) ; ?>" />
  ...
  <?php }else{ ?>
    ...
    <form action="<?php print $_SERVER['PHP_SELF'] ?>" method="post">
      ...
      <input type="hidden" name="szamlalo" id="szamlalo" value="<?php echo ( isset( $_POST['szamlalo'] ) ? $_POST['szamlalo'] : 1 ) ?>" />
